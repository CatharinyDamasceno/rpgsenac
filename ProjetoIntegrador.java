...
//Switch case Da Opção
    ...
    fl[0][0]="Eu Sabia que não conseguiria acertar hahaha \nÉ demais mesmo para você Batman \n";
    fl[0][1]="Oque foi Batman?? \nNão consegue pensar estando sobre pressão? hahahahaha \n";
    fl[0][2]="Sabe, acho que te superestimei Batman \nVocê não é tudo isso hahahha \n";
    fl[0][3]="Seria mais divertido se você fosse inteligente Batman \n";
    
    fl[1][0]="Oque?? como??? \nNão tinha como você Saber éssa \n";
    fl[1][1]="Eu não sei como... \nMas você esta trapaceando \n";
    fl[1][2]="GRRRRR É impossivel que alguem Consiga responder essa nessa situação \n";
    fl[1][3]="Como é que você está obtendo as respostas Morcego Trapaceiro?? \n";
                ...
                if (hpComputador>0 && escolhaAtaque!=9 && controlQuest<20){
                    ...
                    switch (escolhaAtaque){ // Ataque do computador vem de um random de 1 a 4
                        ...
                        case 3:
                            ...
                            }else{System.out.println("=== Adversario aplicou um ataque especial. === \n"); // Se sair outro numero o jogador leva o golpe
